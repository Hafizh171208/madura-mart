<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
            ...
            <a class="nav-link" href="../pages/tables.html">
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"
                        style="width: 25px; height: 25px; transform: scale(1.3) translateY(1px); display: block;">
                        <line x1="12.345" y1="11.75" x2="15.25" y2="11.75" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            data-color="color-2"></line>
                        <path d="M8.779,4.67l-.231-.313c-.283-.382-.73-.608-1.206-.608h-1.458c-.388,0-.761,.151-1.041,.42l-1.867,1.8
                 c-.07,.067-.148,.123-.232,.167" fill="none" stroke="#1c1f21" stroke-linecap="round"
                            stroke-linejoin="round" stroke-width="1.5"></path>
                        <path d="M2.75,11.75h1.26c.303,0,.59,.138,.78,.374l1.083,1.349c.596,.742,1.632,.962,2.478,.525l3.274-1.693
                 c1.111-.574,1.428-2.016,.661-3.003l-1.648-2.122" fill="none" stroke="#1c1f21"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                        <path
                            d="M15.258,6.138c-.085-.044-.163-.1-.233-.168l-1.867-1.8c-.28-.269-.653-.42-1.041-.42h-1.807
                 c-.404,0-.791,.163-1.074,.453l-2.495,2.558c-.498,.51-.493,1.326,.011,1.83h0c.447,.447,1.15,.508,1.668,.145l2.83-1.985"
                            fill="none" stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1.5" data-color="color-2"></path>
                        <path d="M.75,5.25H1.75c.552,0,1,.448,1,1v6c0,.552-.448,1-1,1H.75" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                        <path d="M17.25,5.25h-1c-.552,0-1,.448-1,1v6c0,.552,.448,1,1,1h1" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
        ...
        <li class="nav-item">
            <a class="nav-link" href="../pages/tables.html">
                <div class="icon icon-shape shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" style="width: 20px; height: 20px;">
                        <path
                            ...
                            stroke="#1c1f21" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                            fill="none"></path>
                        <path d="M1.953 14.5C3.1574 12.6813 5.15919 11.4395 7.45889 11.2699" stroke="#1c1f21"
                        ...
                        <path
                            ...
                            stroke="#1c1f21" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                            fill="none"></path>
                        <path d="M8.75 15.75H5.75" stroke="#1c1f21" stroke-width="1.5" stroke-linecap="round"
            ...
            <a class="nav-link" href="../pages/tables.html">
                <div class="icon icon-shape shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" style="width: 20px; height: 20px;">
                        ...
                        <line x1="4.231" y1="13.25" x2="7.75" y2="13.25" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                        </line>
                        <path d="M11.176,8.75H2.75c-1.105,0-2,.895-2,2v2.75" fill="none" stroke="#1c1f21"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                        <path d="M17.25,15.25h-2.5c-.552,0-1-.448-1-1V1.75" fill="none" stroke="#1c1f21"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                        <circle cx="2.5" cy="13.5" r="1.75" fill="none" stroke="#1c1f21"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></circle>
                        <circle cx="9.5" cy="13.5" r="1.75" fill="none" stroke="#1c1f21"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></circle>
                    </svg>
                </div>
        ...
        <li class="nav-item">
            <a class="nav-link" href="../pages/billing.html">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"
                        style="width: 25px; height: 25px; transform: scale(1.5); display: block;">
                        <line x1="9" y1="2.25" x2="9" y2="8.25" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                        </line>
                        <rect x="2.75" y="5.25" width="12.5" height="10" rx="2" ry="2"
                            fill="none" stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1.5"></rect>
                        <path d="M3,6.284l1.449-2.922c.338-.681,1.032-1.112,1.792-1.112h5.518
                        c.76,0,1.454,.431,1.792,1.112l1.449,2.923" fill="none" stroke="#1c1f21"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                        <line x1="5.25" y1="12.75" x2="7.25" y2="12.75" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                        </line>
                    </svg>
                </div>
        ...
        <li class="nav-item">
            <a class="nav-link" href="../pages/virtual-reality.html">
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"
                        style="width: 25px; height: 25px; transform: scale(1.3) translateY(1px); display: block;">
                        <line x1="4.75" y1="6.25" x2="7.25" y2="1.75" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            data-color="color-2"></line>
                        <line x1="13.25" y1="6.25" x2="10.75" y2="1.75" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            data-color="color-2"></line>
                        <path d="M15,6.25l-.597,7.166c-.086,1.037-.953,1.834-1.993,1.834H5.59
                        c-1.04,0-1.907-.797-1.993-1.834l-.597-7.166" fill="none" stroke="#1c1f21"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                        <line x1="1.75" y1="6.25" x2="16.25" y2="6.25" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                        </line>
                    </svg>
                </div>
                ...
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"
                        ...
                        <path
                            ...
                            C13.4701 10.25 13.8457 9.98691 13.9894 9.59171L15.2618 6.09171C15.4989 5.43951 15.0159 4.75 14.322 4.75H4.11801"
                            stroke="#1c1f21" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                            fill="none"></path>
                        <path
        ...
        <li class="nav-item">
            <a class="nav-link" href="../pages/rtl.html">
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"
                        style="width: 25px; height: 25px; transform: scale(1.3) translateY(1px); display: block;">
                        <path d="m2.25,4.25h5.586c.265,0,.52.105.707.293l5.1065,5.1065c.781.781.781,2.047,0,2.828l-3.172,3.172
                        c-.781.781-2.047.781-2.828,0l-5.1065-5.1065c-.188-.188-.293-.442-.293-.707v-5.586Z"
                            fill="none" stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1.5">
                        </path>
                        <path d="m3.75,1.25h5.586c.265,0,.52.105.707.293l5.7705,5.7705" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            data-color="color-2"></path>
                        <circle cx="5.75" cy="7.75" r="1.25" fill="#1c1f21" stroke-width="0"
        ...
        <li class="nav-item">
            <a class="nav-link" href="../pages/rtl.html">
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"
                        style="width: 25px; height: 25px; transform: scale(1.3) translateY(1px); display: block;">
                        <circle cx="9" cy="4.5" r="2.75" fill="none" stroke="#1c1f21"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" data-color="color-2">
                        </circle>
                        <path d="M13.762,15.516c.86-.271,1.312-1.221,.947-2.045-.97-2.191-3.159-3.721-5.709-3.721s-4.739,1.53-5.709,3.721
                 c-.365,.825,.087,1.774,.947,2.045,1.225,.386,2.846,.734,4.762,.734s3.537-.348,4.762-.734Z"
                            fill="none" stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1.5"></path>
                    </svg>
                </div>
            ...
            <a class="nav-link  " href="../pages/profile.html">
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40px" height="40px"
                        ...
                        <polyline points="11.5 5.75 9 8.25 6.5 5.75" fill="none" stroke="#1c1f21"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" data-color="color-2">
                        </polyline>
                        <line x1="9" y1="8.25" x2="9" y2="2.75" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            data-color="color-2"></line>
                        <path d="M16.214,9.75h-4.464v1c0,.552-.448,1-1,1h-3.5c-.552,0-1-.448-1-1v-1H1.787"
                            fill="none" stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1.5"></path>
                        <path
                ...
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40px" height="40px"
                        ...
                        <path d="M7.99707 11.25L9.60605 12.75L13.0031 8.25" stroke="#1c1f21" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round" data-color="color-2" fill="none">
                        </path>
                        <path
                        ...
                        <path
                            ...
                            stroke="#1c1f21" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                            data-color="color-2" fill="none"></path>
                    </svg>
                </div>
        ...
        <li class="nav-item">
            <a class="nav-link  " href="../pages/sign-up.html">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="60px" height="60px"
                        viewBox="0 0 12 12">
                        <title>Report Purchase</title>
                        <path d="m10.25,4.5v4.25c0,1.105-.895,2-2,2h-2.25s-2.25,0-2.25,0c-1.105,0-2-.895-2-2v-4.25"
                            fill="none" stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1.5"></path>
                        <rect x=".75" y="1.25" width="10.5" height="3" rx="1" ry="1"
                            fill="none" stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1.5" data-color="color-2"></rect>
                        <line x1="5" y1="6.75" x2="7" y2="6.75" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            data-color="color-2"></line>
                    </svg>
                </div>
                ...
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40px" height="40px"
                        ...
                        <rect x="2.25" y="11.75" width="2.5" height="3.5" rx="1" ry="1"
                            fill="none" stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1.5"></rect>
                        <polyline points="6.25 2.75 8.75 2.75 8.75 5.25" fill="none" stroke="#1c1f21"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" data-color="color-2">
                        </polyline>
                        <line x1="8.5" y1="3" x2="2.75" y2="8.75" fill="none"
                            stroke="#1c1f21" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            data-color="color-2"></line>
                    </svg>
                </div>
