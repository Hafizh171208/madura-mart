                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-uppercase text-xs text-secondary mb-0 opacity-7 ps-4">1.</td>
                                            <td class="text-uppercase text-xs text-secondary mb-0 opacity-7 ps-4">PT. ABC</td>
                                            <td class="text-uppercase text-xs text-secondary mb-0 opacity-7 ps-4">Jakarta</td>
                                            <td class="text-uppercase text-xs text-secondary mb-0 opacity-7 ps-4">0812345678910</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
