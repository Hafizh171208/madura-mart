                                ...
                                <div class="row ms-3 me-3">
                                    <div class="col-12">
                                        <div class="mb-3 px-3 pt-3">
                                            ...
                                            <input type="text" class="form-control" id="nama_distributor" name="nama_distirbutor" placeholder="Enter Distributor Name">
                                        </div>
                                        <div class="mb-3 px-3 pt-3">
                                            <label for="alamat_distributor" class="form-label">Alamat Distributor</label>
                                            <textarea type="text" class="form-control" id="alamat_distributor" name="alamat_distirbutor" rows="5" placeholder="Enter Address"></textarea>
                                        </div>
                                        <div class="mb-3 px-3 pt-3">
                                            <label for="notelpon_distributor" class="form-label">No. Telp</label>
                                            <input type="text" class="form-control" id="notelpon_distributor" name="notelpon_distirbutor" placeholder="Enter Phone Number">
                                        </div>
                                    </div>
                                </div>
